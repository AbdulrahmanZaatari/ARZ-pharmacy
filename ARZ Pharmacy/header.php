                ...
                <div class="row">
                    <div class="col-md-7">
                        <div class="ltn__top-bar-menu">
                            <ul>
                                <li><a href="mailto:PharmcyARZ@gmail.com?Subject=Flower%20greetings%20to%20you"><i class="icon-mail"></i> PharmacyARZ@gmail.com</a></li>
                            </ul>
                        </div>
                    </div>
                    <div class="col-md-5">
                                        ...
                                        <ul>
                                            <li>
                                                ...
                                                <ul style="width: 320px;">
                                                            ...
                                                            <li><a href="sendMessage.php">Ask Questions</a></li>
                                                            <li><a href="logout.php">Logout</a></li>
                                                            <li><a href="registerPharmacist.php">Register as Pharmacist</a></li>
                                                            <li><a href="pharmacistLogin.php">Log in as Pharmacist</a></li>
                                                            <li><a href="ownerLogin.php">Log in as Owner</a></li>
                                                </ul>
                                            </li>
                                        </ul>
                                    </div>
