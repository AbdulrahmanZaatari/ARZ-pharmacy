...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        ...
        $ehr_details = "
            ...
            Stress Level: {$_POST['stress_level']}
...
<form action="register_ehr.php" method="POST" class="ltn__form-box contact-form-box">
                        ...
                        <div class="mb-3">
                            <label>On a scale of 1 to 10, how would you rate your current stress level?</label><br>
                            <input type="range" name="stress_level" min="1" max="10" required>
                        </div>
                        <div class="mb-3">
